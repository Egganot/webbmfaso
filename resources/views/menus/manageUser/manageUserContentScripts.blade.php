<script>
    document.addEventListener('alpine:init', () => {
        ...
        Alpine.data('invoiceList', () => ({
            selectedRows: [],
            initialItems: @json($users),
            searchText: '',
            datatable: null,
            dataArr: [],

            init() {
                console.log('Initial Items:', this.initialItems);
                this.dataArr = this.initialItems.map(item => [
                    false,
                    item.username,
                    item.karyawan ? item.karyawan.foto : 'N/A',
                    item.karyawan ? item.karyawan.nama : 'N/A',
                    item.karyawan ? item.karyawan.email : 'N/A',
                    item.karyawan ? item.karyawan.telegram : 'N/A',
                    item.division,
                    item.role,
                    '',
                ]);
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, cell, row) {
                                ...
                                return `<div class="flex items-center font-semibold"><div class="p-0.5 bg-white-dark/30 rounded-full w-max ltr:mr-2 rtl:ml-2"><img class="h-8 w-8 rounded-full object-cover" src="${imagePath}" /></div>${name}</div></div>`;
                            },
                        },
                        {
                            select: 3,
                                                    ...
                                                    <div x-show="open" x-transition x-transition.duration.300
                                                        ...
                                                        <div class="p-5">
                                                            ...
                                                            <form class="space-y-2">
                                                                <div>
                                                                    <input type="text" name="username" placeholder="Username" class="form-input" readonly
                                                                        style="background: lightgrey" />
                                                                </div>
                                                                <div>
                                                                    <input type="text" name="name" placeholder="Name" class="form-input" readonly
                                                                        style="background: lightgrey" />
                                                                </div>
                                                                <div>
                                                                    <input type="text" name="email" placeholder="E-mail" class="form-input" readonly
                                                                        style="background: lightgrey" />
                                                                </div>
                                                                <div>
                                                                    <input type="text" name="telegram" placeholder="Telegram" class="form-input" readonly
                                                                        style="background: lightgrey" />
                                                                </div>
                                                            </form>
                                                            {{-- Division Dropdown --}}
                                                            <div class="dropdown inline-flex mt-2" name="division" x-data="dropdown"
                                                                @click.outside="open = false">
                                                                <button type="button" class="btn btn-dark ltr:rounded-r-none rtl:rounded-l-none">
                                                                    Division
                                                                </button>
                                                                <button type="button"
                                                            ...
                                                            {{-- Role Dropdown --}}
                                                            <div class="dropdown inline-flex mt-2" name="role" x-data="dropdown"
                                                                @click.outside="open = false">
                                                                <button type="button" class="btn btn-dark ltr:rounded-r-none rtl:rounded-l-none">
                                                                    Role
                                                                </button>
